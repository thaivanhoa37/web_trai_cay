...
class HomeController extends Controller
{
    public function index(Request $request) {
        ...
        // SEO
        $meta_keywords = "trai cay mien tay, trái cây , trái cây";
        $meta_title = "VH Fruit - Thương hiệu trái cây  số 1 Việt Nam";
        $meta_desc = "Đơn vị chuyên phân phối sỉ và lẻ trái cây với chất lượng và giá cả tốt nhất thị trường";

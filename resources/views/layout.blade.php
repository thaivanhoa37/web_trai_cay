...
<body>
    ...
    <header class="mb-3 fixedElement">
        ...
        <div class="wrapper-top py-1">
            <div class="container">
                <div class="detail">
                    <a class="map-top" href="https://goo.gl/maps/zm4MPY3XfUV6NNmN9"><i class="fas fa-map-marker-alt"></i> ###################### |</a>
                    <a href="tel: 0123456789"><i class="m-lg-1 fas fa-phone-alt"></i> 0123456789</a>
                </div>
                <div class="social">
                    Social:
        ...
        <div class="container-fluid pb-3 header-pc">
            <div class="row">
                <a class="col-sm-1" href="{{url('/')}}" title="VH Fruit - Thương hiệu trái cây  số 1 Việt Nam">
                ...
                <div class="col-sm-2">
                    <div class="row">
                        ...
                        <div class="col-md-9 mt-3">
                            ...
                            <a class="item-row2 text-danger" href="tell: 0123456789">0123456789</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                ...
                <div class="col-sm-4">
                    <div class="row">
                        ...
                        <div class="col-md-10 mt-3">
                            <a class="item-row1" href="#">Sản phẩm VH Fruits</a><br/>
            ...
            <div class="row">
                <div class="navbar">
                    <ul class="nav">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#">Fanpage</a></li>
                        <li class="nav-item dropdown subnav-item">
        ...
        <div class="nav-responsive">
            <div class="logo-homepage">
                <a class="icon-logo" href="{{url('/')}}" title="PT Fruit - Thương hiệu trái cây miền Tây số 1 Việt Nam">
                    <img src="{{url('public/client/img/logo-mobile.png')}}" alt="VH Fruit - Thương hiệu trái cây  số 1 Việt Nam">
                </a>
            </div>
            <div class="nav-wrapper-res">
                ...
                <div class="show-nav-res js-nav-social">
                    <ul class="nav-row row js-row-social">
                        ...
                        <li class="col-md-5 nav-row-item">
                            <a href="tel:wwwwwwwwwwww ">##########</a>
                        </li>
                        <li class="col-md-5 nav-row-item">
                            <a href="tel: ############">############ (giờ hành chính)</a>
                        </li>
    ...
    <footer>
        <div class="footer">
            <div class="container">
                <div class="row mx-0">
                    <div class="col-md-5">
                        <p>
                            ...
                            <span>&emsp;&emsp;<i class="mr-3 fas fa-map-marker-alt"></i>Địa chỉ:<a class="row-bottom-2" href="#"> @@@@@@@@@@@@@@@@@@@@@@@@</a></span><br>
                            <span>&emsp;&emsp;<i class="mr-3 fas fa-phone-alt"></i>Điện thoại:<a class="row-bottom-2" href="tel: ###########"> ###########</a></span><br>
                            <span>&emsp;&emsp;<i class="mr-3 fas fa-envelope"></i>Email:<a class="row-bottom-2" href="mailto: !!!!!!!!!!!!!!!!"> !!!!!!!!!!!!!!!!</a></span>
                        </p>
                        <p>
                ...
                <div class="row container">
                    ...
                    <div class="col-md-6 copyright">Coppyright©2022 Fruit All Rights Reserved | Designed by ADMIN</div>
                </div>
            </div>
        </div>
        <div class="row-bottom">
            <div class="row">
                <div class="col-md-2">
                    <span class="row-bottom-1">Mua hàng:<a class="row-bottom-2" href="tel: 0000000000000"> 0000000000000</a></span>
                </div>
                <div class="col-md-3">
                    <span class="row-bottom-1">Hotline:</span>
                    <a class="row-bottom-2" href="tel: 00000000000"> 00000000000</a>
                    <span> (giờ hành chính)</span>
                </div>
                <div class="col-md-3">
                    <span class="row-bottom-1">Email:</span>
                    <a class="row-bottom-2" href="mailto: !!!!!!!!!!!!!!!!!!!!!!"> !!!!!!!!!!!!!!!!!!!!!!</a>
                </div>
            </div>
        </div>
    </footer>

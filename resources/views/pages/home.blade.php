...
<div class="wrap-banner">
    ...
    <div class="container text-center">
        <div class="title-content">
            <img src="{{url('public/client/img/dot-title-left.png')}}" alt=""> VH Fruit - Fresh fruit & organic food <img src="{{url('public/client/img/dot-title-right.png')}}" alt=""></div>
        <div class="descript-introduce">
            ...
            <span class="text-uppercase"><i class="pr-3 fas fa-greater-than"></i>Hãy để <a href="{{url('/')}}">VH Fruit</a> giải quyết tất cả các vấn đề này cho bạn.</span>
        </div>
